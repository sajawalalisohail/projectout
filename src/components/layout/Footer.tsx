  ...
  return (
    <>
      ...
      <footer
        ref={footerRef}
        className={cn(
          "fixed bottom-0 left-0 right-0 z-0 overflow-hidden",
          bgColor
        )}
      >
          ...
          <Container>
            <div className="flex flex-col items-center gap-16">
              ...
              <div className="flex flex-col items-center gap-8">
                {/* Logo with Tagline */}
                <a href="/" className="group relative flex flex-col items-center gap-4">
                  <Image
                  ...
                  <span
                    className={cn(
                      "text-[10px] font-medium uppercase tracking-[0.2em] leading-none transition-colors duration-300",
                      isDark ? "text-white/40 group-hover:text-white/60" : "text-[#1C1F26]/40 group-hover:text-[#1C1F26]/60"
                    )}
                  >
                    ...
                    <a
                      ...
                      className={cn(
                        ...
                        isDark
                          ...
                          : "bg-black/5 text-[#1C1F26]/60 hover:bg-black/10 hover:text-[#1C1F26]"
                      )}
              ...
              <div className="flex flex-wrap justify-center gap-x-16 gap-y-10 w-full">
                {Object.entries(footerLinks).map(([category, links]) => (
                  <div key={category} className="flex flex-col items-center gap-6">
                    <h3 className={cn(
                      ...
                      isDark ? "text-white/30" : "text-[#1C1F26]/30"
                    )}>
                      {category}
                    </h3>
                      ...
                      {links.map((link) => (
                        <li key={link.label}>
                          <a
                            href={link.href}
                            className={cn(
                              "group inline-flex items-center gap-2 text-sm font-medium transition-colors duration-200",
                              isDark
                          ...
                          >
                            ...
                            {/* Arrow on hover */}
                            <svg
                              className="h-3 w-3 -translate-x-2 opacity-0 transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
            ...
            {/* Bottom Line */}
            <div className={cn(
              "mt-20 flex flex-col items-center justify-center border-t pt-8",
              borderColor
            )}>
              <p className={cn("text-xs font-medium text-center", textColorSubtle)}>
